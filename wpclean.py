...
txttoclean = txttoclean + '<i>Want to learn more about Mark or ask him to write about a strategic, operations or ' +\
             ...
             'linkedin.com/in/markriffey" target="_blank" rel="noopener noreferrer">LinkedIn</a> or <a class="text" ' + \
             'href="http://www.twitter.com/MarkRiffey" target="_blank" rel="noopener noreferrer">Twitter</a>, or ' + \
             'email him at <a class="text" href="mailto:mriffey@flatheadbeacon.com">mriffey@flatheadbeacon.com</a>.</i>'
